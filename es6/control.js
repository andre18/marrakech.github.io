class Control {
    ...
    gamersQueue() {
        ...
        this.blueFill = '#401ab7';
        this.blueStroke = '#140a44';
        this.yellowFill = '#ffe51d';
        this.yellowStroke = '#4ba416';
        ...
        if (this.gamersNames.length === 1) {
            this.gamer1 = new Gamer(1, this.gamersNames[0], 20, 30, 0, this.carpet_1, '#89B86F');
            this.gamer2 = new Computer(2, "Computer", 20, 30, 0, this.carpet_2, '#2E43BD');
            this.gamer1.naming();
            this.gamer2.naming();
        ...
        if (this.gamersNames.length === 2) {
            this.gamer1 = new Gamer(1, this.gamersNames[0], 20, 30, 0, this.carpet_1, '#89B86F');
            this.gamer2 = new Gamer(2, this.gamersNames[1], 20, 30, 0, this.carpet_2, '#2E43BD');
            this.gamer1.naming();
            this.gamer2.naming();
            this.assan.currentGamerObj = this.gamer1;
            // this.assan.gamersQue(this.gamer2.id, this.gamer1.id);
        ...
        if (this.gamersNames.length === 3) {
            ...
            this.gamer1 = new Gamer(1, this.gamersNames[0], 20, 30, 0, this.carpet_1, '#89B86F');
            this.gamer2 = new Gamer(2, this.gamersNames[1], 20, 30, 0, this.carpet_2, '#2E43BD');
            this.gamer3 = new Gamer(3, this.gamersNames[2], 20, 30, 0, this.carpet_3, '#8372BA');
            this.gamer1.naming();
            this.gamer2.naming();
            this.gamer3.naming();
            this.assan.currentGamerObj = this.gamer1;
        ...
        if (this.gamersNames.length === 4) {
            ...
            this.gamer2 = new Gamer(2, this.gamersNames[1], 20, 30, 0, this.carpet_2, '#2E43BD');
            this.gamer3 = new Gamer(3, this.gamersNames[2], 20, 30, 0, this.carpet_3, '#8372BA');
            this.gamer4 = new Gamer(4, this.gamersNames[3], 20, 30, 0, this.carpet_4, '#D45A5A');
            this.gamer1.naming();
            this.gamer2.naming();
            this.gamer3.naming();
            this.gamer4.naming();
    ...
    //метод для отображения данных об реальном игроке в режиме "одиночная игра"
    ...
    //                 this.gamer1.displayInfo(countCarpet = 1, countCarpOnField = 2, countMoney);
    //             }
    //             if (this.carpetsID[this.countX][this.countY].carpet === this.gamer1.carpet || this.carpetsID[this.countX1][this.countY1].carpet === this.gamer1.carpet) {
    //                 if (this.carpetsID[this.countX][this.countY].carpet === this.gamer1.carpet && this.carpetsID[this.countX1][this.countY1].carpet === this.gamer1.carpet) {
    //                     this.gamer1.displayInfo(countCarpet = 1, countCarpOnField = 0, countMoney);
    //                 } else {
    //                     this.gamer1.displayInfo(countCarpet = 1, countCarpOnField = 1, countMoney);
    //                 }
    //             } else if (this.carpetsID[this.countX][this.countY].carpet === this.gamer2.carpet || this.carpetsID[this.countX1][this.countY1].carpet === this.gamer2.carpet) {
    //                 if (this.carpetsID[this.countX][this.countY].carpet === this.gamer2.carpet && this.carpetsID[this.countX1][this.countY1].carpet === this.gamer2.carpet) {
    //                     this.gamer1.displayInfo(countCarpet = 1, countCarpOnField = 2, countMoney);
    //                     this.gamer2.displayInfo(countCarpet = 0, countCarpOnField = -2, countMoney);
    //                 } else {
    //                     this.gamer1.displayInfo(countCarpet = 1, countCarpOnField = 2, countMoney);
    //                     this.gamer2.displayInfo(countCarpet = 0, countCarpOnField = -1, countMoney);
    //                 }
    //             }
    //
    ...
    //             this.carpetsID[this.countX][this.countY].carpet = this.gamer1.carpet;
    //             this.carpetsID[this.countX1][this.countY1].carpet = this.gamer1.carpet;
    //             this.assan.currentGamer = this.gamer2.id;
    //             this.assan.currentGamerCarpet = this.gamer2.carpet;
    //             // this.assan.gamersQue(this.gamer1.id, this.gamer2.id);
    //             this.gamersQueueHTML(this.gamer1);
    //
    ...
    gamersQueueHTML(gamer) {
        ...
        currentGamerName.style.textShadow = "0 0 20px #FFFC16";
